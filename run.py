...
def main(targets):
    ...
    if 'test' in targets:
        ...
        if 'pytorch_model.bin'  in files:
            print('Since the model parameters have large size (>100 Mb), it could not be uploaded to github. We are figuring out a way to share the model with you. Some sample outputs generated from the model are in path `PrefixTuning/gpt2/res/webNLG_results2.`')
        else:
